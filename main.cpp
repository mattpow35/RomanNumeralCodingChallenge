...
void DisplayOptions() {
    cout << "1: Convert a roman numeral to modern number." << endl;
    cout << "2: Convert a modern number to roman numeral." << endl;
    cout << "3: QUIT" << endl;
}
...
void TestRomanNumConverter() {
    ...
    cout << "3999 as a roman numeral should be MCMLXXXIV ";
